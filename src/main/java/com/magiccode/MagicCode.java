...
import com.magiccode.config.ConfigLoader;
import com.magiccode.print.PrintMode;
import com.magiccode.remote.RemoteServer;
import com.magiccode.tui.MagicCodeModel;
...
public class MagicCode {
    ...
    public static void main(String[] args) {
        ...
        // 环境变量回退
        if (configPath == null) {
            String envPath = System.getenv("MAGICCODE_CONFIG");
