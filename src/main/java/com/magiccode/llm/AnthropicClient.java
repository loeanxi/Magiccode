...
public class AnthropicClient implements LlmClient {
    ...
    public AnthropicClient(ProviderConfig cfg, String systemPrompt) {
        ...
        if (apiKey.isEmpty()) {
            throw new LlmException.AuthenticationException(
                    "Anthropic API key not found. Set it in .magiccode/config.yaml or via ANTHROPIC_API_KEY env var.");
        }
    ...
    private void doStream(ConversationManager conv, List<Map<String, Object>> tools,
        ...
        // tools, then the tail of the final user message.
        ...
        try (StreamResponse<RawMessageStreamEvent> streamResponse =
            ...
            while (iterator.hasNext()) {
                ...
                if (event.isContentBlockStart()) {
                    ...
                    // Override only when > 0 to avoid clobbering valid message_start data.
     ...
     * the final user-role message in {@code messages}.
     */
