...
public class ToolRegistry {
    ...
    public static ToolRegistry createDefault() {
        ...
        reg.register(new com.magiccode.tool.impl.ReadFileTool());
        reg.register(new com.magiccode.tool.impl.WriteFileTool());
        reg.register(new com.magiccode.tool.impl.EditFileTool());
        reg.register(new com.magiccode.tool.impl.BashTool());
        reg.register(new com.magiccode.tool.impl.GlobTool());
        reg.register(new com.magiccode.tool.impl.GrepTool());
        return reg;
    }
}
