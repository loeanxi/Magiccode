...
public class HistoryStore {
    ...
    /** Default constructor &mdash; stores history in {@code ~/.magiccode/prompt_history.jsonl}. */
    public HistoryStore() {
        this(Path.of(System.getProperty("user.home"), ".magiccode", "prompt_history.jsonl"));
    }
