package com.magiccode.prompt;

import com.magiccode.prompt.PromptBuilder.EnvironmentContext;
import com.magiccode.prompt.PromptBuilder.Section;
...
public final class PromptSections {
    ...
    static final String IDENTITY_CONTENT = """
            You are MagicCode, an AI programming assistant running in the terminal. You help users with \
